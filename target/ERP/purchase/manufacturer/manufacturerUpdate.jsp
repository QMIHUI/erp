...
<div class="formbody">
  ...
  <ul class="forminfo">
    <li>
      <label>厂商名称</label>
      <input name="" type="text" value="阿里巴巴" class="dfinput" />
      <i>必填，不能超过50个字符</i>
    </li>
    <li>
      <label>负责人</label>
      <input name="" type="text" value="马云" class="dfinput" />
       <i>必填，不能超过30个字符</i>
    </li>
    <li>
      <label>联系方式</label>
    ...
    <li>
      <label>描述</label>
      <textarea class="textinput">阿里巴巴上市公司</textarea>
      <i>可选</i>
    </li>
    <li>
      <label>状态</label>
    ...
    <li>
      <label>创建人</label>
      <input name="" type="text" value="曹操" readonly="readonly" class="roinput" />
      <i>不能编辑</i>
    </li>
    <li>
      <label>创建时间</label>
