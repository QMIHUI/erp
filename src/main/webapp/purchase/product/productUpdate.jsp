...
<form action="${pageContext.request.contextPath}/doUpdateProduct.do?id=${product.productId}" method="post">
    <div class="formbody">
        ...
        <ul class="forminfo">
            ...
            <li>
                <label>商品型号</label>
                <input name="productModel" type="text" value="${product.productModel}" class="dfinput" />
                <i>必填，不能超过50个字符</i>
            </li>
            <li>
                <label>单位</label>
                <input name="productUnit" type="text" value="${product.productUnit}" class="dfinput" />
                <i>必填，不能超过10个字符</i>
            </li>
            <li>
                <label>进价</label>
            ...
            <script type="text/javascript">
                $(function () {
                    ...
                    $("select[name='type']").val(${product.type.typeId});
                    $("select[name='firm']").val(${product.firm.firmId});
                    $("select[name='productStatus']").val(${product.productStatus});
            ...
            <li>
                <label>创建人</label>
                <input name="creater" type="text" value="${product.creater.uname}" readonly="readonly" class="roinput" />
                <i>不能编辑</i>
            </li>
            <li>
                <label>创建时间</label>
                <input name="createTime" type="text" value="<fmt:formatDate value="${product.createTime}" pattern="yyyy-MM-dd HH:MM:ss"/>" readonly="readonly" class="roinput" />
                <i>不能编辑</i>
            </li>
            <li>
                <label>&nbsp;</label>
