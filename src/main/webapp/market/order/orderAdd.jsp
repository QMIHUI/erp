...
<form action="${pageContext.request.contextPath}/addOrderSucc.do" method="get">
    <div class="formbody">
        ...
        <ul class="forminfo">
            <li>
                <label>订单编号</label>
                <input name="orderId" type="text" value="${orderIdAdd}" readonly="readonly" class="roinput" />
                <i>自动生成不能编辑</i>
            </li>
            <li>
                <label>顾客姓名</label>
           ...
           <%-- <li>
            ...
            <li>
                <label>创建人</label>
                <input name="operator" type="text" value="${user.uId}" readonly="readonly" class="roinput" />
                <i>不能编辑</i>
            </li>
            <li>
                <label>审核状态</label>
            ...
            <li>
                <label>总金额</label>
                <input name="orderTotalMoney" type="text" readonly="readonly" class="roinput" />
                <i>自动运算，不能编辑</i>
            </li>
            <li>
        ...
        <table class="tablelist">
            ...
            <tr>
                ...
                <td>￥<input type="text" name="productPrice" value="${productList[0].productPrice+500}" readonly/></td>
